...
if __name__ == "__main__":
    spark = (SparkSession.builder.appName('AWS_Spark_Job_Posting')
    ...
    query = streamWriter(union_dataframe, 's3a://spark-job-postings/checkpoints/',
                         's3a://spark-job-postings/data/spark_unstructured')
